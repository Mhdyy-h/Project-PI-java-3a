...
public class CommunityController {
    ...
    private void handleBackToDashboard() {
        org.example.service.NavigationService.getInstance()
                .navigateToDashboard(groupsContainer, currentUser);
    }

    @FXML
    private void handleLogout() {
        org.example.service.NavigationService.getInstance()
                .navigateToLogin(groupsContainer);
    }
    ...
    private void switchScene(String fxmlPath, String title, Groupe groupToEdit, Evenement eventToEdit) {
        try {
            ...
            if (groupToEdit != null) {
                ...
                // New form — still pass the user
                Object ctrl = loader.getController();
                if (ctrl instanceof GroupFormController c) c.setCurrentUser(currentUser);
                if (ctrl instanceof EventFormController c) c.setCurrentUser(currentUser);
            }
    ...
    public void handleAddGroup(ActionEvent actionEvent) {
    }
}