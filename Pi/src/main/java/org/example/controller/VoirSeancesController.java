...
public class VoirSeancesController {
    ...
    private void mettreAJourCompteur() {
        ...
        if (filtre == total) {
            compteurLabel.setText("📋 " + total + " séance(s) disponible(s)");
        } else {
